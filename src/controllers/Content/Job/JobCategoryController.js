// controllers/Content/Job/JobCategoryController.js
...
const getAllCategories = async (req, res) => {
  ...
  const categories = await JobCategory.getAllCategories();
...
const getOneCategory = async (req, res) => {
  ...
  //perform query on database
  const category = await JobCategory.getOneCategory(categoryId);
...
const createOneCategory = async (req, res) => {
  ...
  //perform query on database
  const jobCategory = await JobCategory.createOneCategory(updatedData);
  return sendResponse(res, 201, "Category created successfully", jobCategory);
};
...
const updateOneCategory = async (req, res) => {
  ...
  //perform query on database
  const updatedCategory = await JobCategory.updateOneCategory({
    categoryId,
    updatedData,
  });
  return sendResponse(
...
const deleteOneCategory = async (req, res) => {
  ...
  //perform query on database
  const deletedCategory = await JobCategory.deleteOneCategory(categoryId);
  return sendResponse(
    res,
    200,
